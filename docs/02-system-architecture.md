...
|---|---|---|
| Topology | 1:1 peers, no media server | Unchanged until multi-party (supervisor whisper, conference) — the ADR-1 flip condition for introducing an SFU (e.g. mediasoup) |
